...
app = modal.App("genesage", image=evo2_image)
...
@app.cls(gpu="H100", volumes={mount_path: volume}, max_containers=1, retries=2, scaledown_window=120)
class Evo2Model:
    @modal.enter()
